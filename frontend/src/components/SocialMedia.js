	...
	return (
	  <div className='social-media-roll'>
	    <ul>
	      ...
	      <li className='social-media-link'><a href="https://github.com/lpeaua/PeauaWebDev2.0" target='_blank'><img className='social-media-img' alt='github' src={ require('../assets/images/icons/git-hub-blue.png') }/></a></li>
